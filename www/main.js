(self["webpackChunkmyCircle"] = self["webpackChunkmyCircle"] || []).push([["main"],{
...
const routes = [
    ...
    {
        path: 'buddy-profile',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_buddy-profile_buddy-profile_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./buddy-profile/buddy-profile.module */ 4067)).then(m => m.BuddyProfilePageModule)
    }
];
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        ...
        providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_9__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicRouteStrategy }, _services_app_http_service__WEBPACK_IMPORTED_MODULE_2__.AppHttpService, _angular_common_http__WEBPACK_IMPORTED_MODULE_8__.HttpClient, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.ModalController, _ionic_native_qr_scanner_ngx__WEBPACK_IMPORTED_MODULE_3__.QRScanner],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Buddy": () => (/* binding */ Buddy)
/* harmony export */ });
class Buddy {
}
...
/* harmony import */ var _models_buddy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/buddy */ 9578);
...
let AppHttpService = class AppHttpService {
    constructor(platform, httpBrowser) {
    ...
    getBuddiesList(page) {
        let buddyList = new Array();
        let promise = new Promise((resolve, reject) => {
            this.httpBrowser.get('https://dummyapi.io/data/api/user?limit=10&page=' + page, { headers: this.webHeaders }).subscribe((data) => {
    ...
    getFullProfileDetail(profileId) {
        let buddyInfo = new _models_buddy__WEBPACK_IMPORTED_MODULE_0__.Buddy();
        let promise = new Promise((resolve, reject) => {
            this.httpBrowser.get('https://dummyapi.io/data/api/user/' + profileId, { headers: this.webHeaders }).subscribe((data) => {
                if (data) {
                    buddyInfo = data;
                    resolve(buddyInfo);
                }
    ...
    getPostsList(page) {
        ...
        let promise = new Promise((resolve, reject) => {
            this.httpBrowser.get('https://dummyapi.io/data/api/post?limit=10&page=' + page, { headers: this.webHeaders }).subscribe((data) => {
                if (data && data.data.length > 0) {
                    postList = data.data;
                    resolve(postList);
                }
    ...
    getTagsList() {
        ...
        let promise = new Promise((resolve, reject) => {
            this.httpBrowser.get('https://dummyapi.io/data/api/tag?limit=100', { headers: this.webHeaders }).subscribe((data) => {
                if (data && data.data.length > 0) {
                    tagList = data.data;
                    resolve(tagList);
                }
...
AppHttpService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
